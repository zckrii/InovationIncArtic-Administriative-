...
local yourmessage = "Pump Alpha Activated"
...
Reactor.MouseButton1Down:connect(function()
    ...
    local yourmessage = "Pump Beta Activated"
...
local yourmessage = "Primary Fan Activated"
...
Spawn.MouseButton1Down:connect(function()
    ...
    local yourmessage = "Pump Alpha Deactivated"
...
SecretButton.MouseButton1Down:connect(function()
	fireclickdetector(lump2)
        local yourmessage = "Pump Beta Deactivated"
...
local yourmessage = "Primary Fan Deactivated"
